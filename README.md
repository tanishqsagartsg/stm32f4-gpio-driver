...
This repository contains both **CubeIDE-generated files** and
**custom driver code**.

### CubeIDE Generated (Framework Code)
These folders are auto-generated by STM32CubeIDE and are **not the focus**
of this project:
...
- Startup code
- CMSIS headers
- HAL framework (not used for GPIO logic here)
